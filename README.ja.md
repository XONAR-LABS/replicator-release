...
<p align="center">
  ハードウェアのアイデアを、試作・発注・製造へ進められる形にします。
</p>
...
作りたいものを説明すると、Replicator がアイデアを前に進めます。製品プランの整理、実現方法の分解、部品選定、設計成果物の作成、製造用ファイルの準備、次に取るべき試作・製造ステップまで支援します。
